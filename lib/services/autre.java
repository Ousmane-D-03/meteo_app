//Placecard
Widget placeCard(String placeName, String cityName, bool isFavoritePlace,
...
//Widget pour afficher la liste des places
Widget placesListe(String searchedCity, List<String> places, Map<String, bool> favoritePlaces, Function(String) onFavoriteToggle) {
        return Column(
...
child: Text(
      ...
      ...places.map((place) {
    favoritePlaces[place] ??= false; // initialisation si null
    return placeCard(place, searchedCity, favoritePlaces[place]!,
            onFavoriteToggle: () {
...
//Widget pour afficher la liste des favorisimport 'package:flutter/material.dart';
...
//                                  context: context,
//                                  builder: (context) {
//                                    return placeAlertDialog(
//                                      poi['name'], // nom de la place
//                                      poi['isFavorite'] ?? false, // bool pour favoris
//                                      onFavoriteToggle: () {
//                                        // ici tu peux gérer le toggle favoris
//                                        setState(() {
//                                          poi['isFavorite'] = !(poi['isFavorite'] ?? false);
//                                        });
//                                        Navigator.of(context).pop(); // fermer la dialog si tu veux
//                                      },
//                                    );
//                                  },
//                                );
...
//}
//
////Widget alertdialog pour afficher le nom d'une place et une icone favoris à côté
//Widget placeAlertDialog(String placeName, bool isFavoritePlace,
//    {required VoidCallback onFavoriteToggle}) {
//  return AlertDialog(
//    title: Row(
//      children: [
